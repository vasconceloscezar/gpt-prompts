...
Project details: an application to develop a proof-of-concept AutoGPT-powered Online Shopping Assistant with purchase functionality. The application assists users in making informed purchase decisions within a specific product category and enables them to complete the purchase. The application accepts user inputs for preferences and budget, generates a curated list of product recommendations, allows users to input commands or queries related to the recommended products, and provides a summary of the top three products that best match the user's preferences and budget. 
----------------------------
